...
namespace Services
{
    public class ProductManager:IProductService
    {
        ...
        public Product? GetOneProduct(int id, bool trackChanges)
        {
            ...
            if (product is null)
            {
                throw new Exception("Not Found Product Exception");
        ...
        {
            /*var enitity = _manager.Product.GetOneProduct(productDto.ProductId, true);
            enitity.ProductName = productDto.ProductName;
            enitity.Price = productDto.Price;
            enitity.CategoryId=productDto.CategoryId;*/
